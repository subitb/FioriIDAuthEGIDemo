sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Webapp/FioriIDAuth_EGI_DEMO/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Webapp.FioriIDAuth_EGI_DEMO.test.integration.arrangements.Arrangement", {
