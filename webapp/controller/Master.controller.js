...
sap.ui.define([
		...
		"sap/ui/Device",
		"Webapp/FioriIDAuth_EGI_DEMO/model/formatter"
	], function (BaseController, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, formatter) {
		"use strict";

		return BaseController.extend("Webapp.FioriIDAuth_EGI_DEMO.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("Webapp.FioriIDAuth_EGI_DEMO.view.ViewSettingsDialog", this);
